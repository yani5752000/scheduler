...
// import {defaults, get} from "../../__mocks__/axios" 

import { render, cleanup, waitForElement, fireEvent } from "@testing-library/react";
import { queryByAltText, queryByText, getByText, prettyDOM, getAllByTestId, getByAltText, getByPlaceholderText } from "@testing-library/react";
...
describe("Application", () => {
  ...
  it("loads data, books an interview and reduces the spots remaining for Monday by 1", async () => {
    ...
    //updateSpots function will give this result because way of coding suggested by mentor
